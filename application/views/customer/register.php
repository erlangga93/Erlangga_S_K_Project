...
<head>
  ...
  <title>Erlangga S.K. Project| Registration Page</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <div class="form-group has-feedback">
        ...
        <input type="text" class="form-control" placeholder="masukkan nama member....." name="ip-username">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
        <p class="text-red"><?php echo form_error('ip-username');?></p>
      </div>
      
      <div class="form-group has-feedback">
        <label>Masukkan Password</label>
        <input type="text" class="form-control" placeholder="NMasukkan Password" name="ip-nikadm">
